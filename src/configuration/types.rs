...
pub struct Configuration {
  ...
  /* padding */
  #[serde(rename = "ifStatement.padding.top")]
  pub if_statement_padding_top: u8,
  #[serde(rename = "ifStatement.padding.bottom")]
  pub if_statement_padding_bottom: u8,
  #[serde(rename = "functionDeclaration.padding.top")]
  pub function_declaration_padding_top: u8,
  #[serde(rename = "functionDeclaration.padding.bottom")]
  pub function_declaration_padding_bottom: u8,
  #[serde(rename = "functionExpression.padding.top")]
  pub function_expression_padding_top: u8,
  #[serde(rename = "functionExpression.padding.bottom")]
  pub function_expression_padding_bottom: u8,
  #[serde(rename = "arrowFunction.padding.top")]
  pub arrow_function_padding_top: u8,
  #[serde(rename = "arrowFunction.padding.bottom")]
  pub arrow_function_padding_bottom: u8,
  #[serde(rename = "classDeclaration.padding.top")]
  pub class_declaration_padding_top: u8,
  #[serde(rename = "classDeclaration.padding.bottom")]
  pub class_declaration_padding_bottom: u8,
  #[serde(rename = "classExpression.padding.top")]
  pub class_expression_padding_top: u8,
  #[serde(rename = "classExpression.padding.bottom")]
  pub class_expression_padding_bottom: u8,
  #[serde(rename = "method.padding.top")]
  pub method_padding_top: u8,
  #[serde(rename = "method.padding.bottom")]
  pub method_padding_bottom: u8,
  #[serde(rename = "constructor.padding.top")]
  pub constructor_padding_top: u8,
  #[serde(rename = "constructor.padding.bottom")]
  pub constructor_padding_bottom: u8,
  #[serde(rename = "forStatement.padding.top")]
  pub for_statement_padding_top: u8,
  #[serde(rename = "forStatement.padding.bottom")]
  pub for_statement_padding_bottom: u8,
  #[serde(rename = "forInStatement.padding.top")]
  pub for_in_statement_padding_top: u8,
  #[serde(rename = "forInStatement.padding.bottom")]
  pub for_in_statement_padding_bottom: u8,
  #[serde(rename = "forOfStatement.padding.top")]
  pub for_of_statement_padding_top: u8,
  #[serde(rename = "forOfStatement.padding.bottom")]
  pub for_of_statement_padding_bottom: u8,
  #[serde(rename = "whileStatement.padding.top")]
  pub while_statement_padding_top: u8,
  #[serde(rename = "whileStatement.padding.bottom")]
  pub while_statement_padding_bottom: u8,
  #[serde(rename = "doWhileStatement.padding.top")]
  pub do_while_statement_padding_top: u8,
  #[serde(rename = "doWhileStatement.padding.bottom")]
  pub do_while_statement_padding_bottom: u8,
  #[serde(rename = "switchStatement.padding.top")]
  pub switch_statement_padding_top: u8,
  #[serde(rename = "switchStatement.padding.bottom")]
  pub switch_statement_padding_bottom: u8,
  #[serde(rename = "switchCase.padding.top")]
  pub switch_case_padding_top: u8,
  #[serde(rename = "switchCase.padding.bottom")]
  pub switch_case_padding_bottom: u8,
  #[serde(rename = "tryStatement.padding.top")]
  pub try_statement_padding_top: u8,
  #[serde(rename = "tryStatement.padding.bottom")]
  pub try_statement_padding_bottom: u8,
  #[serde(rename = "catchClause.padding.top")]
  pub catch_clause_padding_top: u8,
  #[serde(rename = "catchClause.padding.bottom")]
  pub catch_clause_padding_bottom: u8,
  #[serde(rename = "finallyClause.padding.top")]
  pub finally_clause_padding_top: u8,
  #[serde(rename = "finallyClause.padding.bottom")]
  pub finally_clause_padding_bottom: u8,
  #[serde(rename = "blockStatement.padding.top")]
  pub block_statement_padding_top: u8,
  #[serde(rename = "blockStatement.padding.bottom")]
  pub block_statement_padding_bottom: u8,
  #[serde(rename = "enumDeclaration.padding.top")]
  pub enum_declaration_padding_top: u8,
  #[serde(rename = "enumDeclaration.padding.bottom")]
  pub enum_declaration_padding_bottom: u8,
  #[serde(rename = "interfaceDeclaration.padding.top")]
  pub interface_declaration_padding_top: u8,
  #[serde(rename = "interfaceDeclaration.padding.bottom")]
  pub interface_declaration_padding_bottom: u8,
  #[serde(rename = "moduleDeclaration.padding.top")]
  pub module_declaration_padding_top: u8,
  #[serde(rename = "moduleDeclaration.padding.bottom")]
  pub module_declaration_padding_bottom: u8,
  #[serde(rename = "objectLiteral.padding.top")]
  pub object_literal_padding_top: u8,
  #[serde(rename = "objectLiteral.padding.bottom")]
  pub object_literal_padding_bottom: u8,
  #[serde(rename = "arrayLiteral.padding.top")]
  pub array_literal_padding_top: u8,
  #[serde(rename = "arrayLiteral.padding.bottom")]
  pub array_literal_padding_bottom: u8,
  #[serde(rename = "staticBlock.padding.top")]
  pub static_block_padding_top: u8,
  #[serde(rename = "staticBlock.padding.bottom")]
  pub static_block_padding_bottom: u8,
}
