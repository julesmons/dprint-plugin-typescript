...
pub fn resolve_config(config: ConfigKeyMap, global_config: &GlobalConfiguration) -> ResolveConfigurationResult<Configuration> {
  ...
  let resolved_config = Configuration {
    ...
    /* padding */
    if_statement_padding_top: get_value(&mut config, "ifStatement.padding.top", 0, &mut diagnostics),
    if_statement_padding_bottom: get_value(&mut config, "ifStatement.padding.bottom", 0, &mut diagnostics),
    function_declaration_padding_top: get_value(&mut config, "functionDeclaration.padding.top", 0, &mut diagnostics),
    function_declaration_padding_bottom: get_value(&mut config, "functionDeclaration.padding.bottom", 0, &mut diagnostics),
    function_expression_padding_top: get_value(&mut config, "functionExpression.padding.top", 0, &mut diagnostics),
    function_expression_padding_bottom: get_value(&mut config, "functionExpression.padding.bottom", 0, &mut diagnostics),
    arrow_function_padding_top: get_value(&mut config, "arrowFunction.padding.top", 0, &mut diagnostics),
    arrow_function_padding_bottom: get_value(&mut config, "arrowFunction.padding.bottom", 0, &mut diagnostics),
    class_declaration_padding_top: get_value(&mut config, "classDeclaration.padding.top", 0, &mut diagnostics),
    class_declaration_padding_bottom: get_value(&mut config, "classDeclaration.padding.bottom", 0, &mut diagnostics),
    class_expression_padding_top: get_value(&mut config, "classExpression.padding.top", 0, &mut diagnostics),
    class_expression_padding_bottom: get_value(&mut config, "classExpression.padding.bottom", 0, &mut diagnostics),
    method_padding_top: get_value(&mut config, "method.padding.top", 0, &mut diagnostics),
    method_padding_bottom: get_value(&mut config, "method.padding.bottom", 0, &mut diagnostics),
    constructor_padding_top: get_value(&mut config, "constructor.padding.top", 0, &mut diagnostics),
    constructor_padding_bottom: get_value(&mut config, "constructor.padding.bottom", 0, &mut diagnostics),
    for_statement_padding_top: get_value(&mut config, "forStatement.padding.top", 0, &mut diagnostics),
    for_statement_padding_bottom: get_value(&mut config, "forStatement.padding.bottom", 0, &mut diagnostics),
    for_in_statement_padding_top: get_value(&mut config, "forInStatement.padding.top", 0, &mut diagnostics),
    for_in_statement_padding_bottom: get_value(&mut config, "forInStatement.padding.bottom", 0, &mut diagnostics),
    for_of_statement_padding_top: get_value(&mut config, "forOfStatement.padding.top", 0, &mut diagnostics),
    for_of_statement_padding_bottom: get_value(&mut config, "forOfStatement.padding.bottom", 0, &mut diagnostics),
    while_statement_padding_top: get_value(&mut config, "whileStatement.padding.top", 0, &mut diagnostics),
    while_statement_padding_bottom: get_value(&mut config, "whileStatement.padding.bottom", 0, &mut diagnostics),
    do_while_statement_padding_top: get_value(&mut config, "doWhileStatement.padding.top", 0, &mut diagnostics),
    do_while_statement_padding_bottom: get_value(&mut config, "doWhileStatement.padding.bottom", 0, &mut diagnostics),
    switch_statement_padding_top: get_value(&mut config, "switchStatement.padding.top", 0, &mut diagnostics),
    switch_statement_padding_bottom: get_value(&mut config, "switchStatement.padding.bottom", 0, &mut diagnostics),
    switch_case_padding_top: get_value(&mut config, "switchCase.padding.top", 0, &mut diagnostics),
    switch_case_padding_bottom: get_value(&mut config, "switchCase.padding.bottom", 0, &mut diagnostics),
    try_statement_padding_top: get_value(&mut config, "tryStatement.padding.top", 0, &mut diagnostics),
    try_statement_padding_bottom: get_value(&mut config, "tryStatement.padding.bottom", 0, &mut diagnostics),
    catch_clause_padding_top: get_value(&mut config, "catchClause.padding.top", 0, &mut diagnostics),
    catch_clause_padding_bottom: get_value(&mut config, "catchClause.padding.bottom", 0, &mut diagnostics),
    finally_clause_padding_top: get_value(&mut config, "finallyClause.padding.top", 0, &mut diagnostics),
    finally_clause_padding_bottom: get_value(&mut config, "finallyClause.padding.bottom", 0, &mut diagnostics),
    block_statement_padding_top: get_value(&mut config, "blockStatement.padding.top", 0, &mut diagnostics),
    block_statement_padding_bottom: get_value(&mut config, "blockStatement.padding.bottom", 0, &mut diagnostics),
    enum_declaration_padding_top: get_value(&mut config, "enumDeclaration.padding.top", 0, &mut diagnostics),
    enum_declaration_padding_bottom: get_value(&mut config, "enumDeclaration.padding.bottom", 0, &mut diagnostics),
    interface_declaration_padding_top: get_value(&mut config, "interfaceDeclaration.padding.top", 0, &mut diagnostics),
    interface_declaration_padding_bottom: get_value(&mut config, "interfaceDeclaration.padding.bottom", 0, &mut diagnostics),
    module_declaration_padding_top: get_value(&mut config, "moduleDeclaration.padding.top", 0, &mut diagnostics),
    module_declaration_padding_bottom: get_value(&mut config, "moduleDeclaration.padding.bottom", 0, &mut diagnostics),
    object_literal_padding_top: get_value(&mut config, "objectLiteral.padding.top", 0, &mut diagnostics),
    object_literal_padding_bottom: get_value(&mut config, "objectLiteral.padding.bottom", 0, &mut diagnostics),
    array_literal_padding_top: get_value(&mut config, "arrayLiteral.padding.top", 0, &mut diagnostics),
    array_literal_padding_bottom: get_value(&mut config, "arrayLiteral.padding.bottom", 0, &mut diagnostics),
    static_block_padding_top: get_value(&mut config, "staticBlock.padding.top", 0, &mut diagnostics),
    static_block_padding_bottom: get_value(&mut config, "staticBlock.padding.bottom", 0, &mut diagnostics),
  };
