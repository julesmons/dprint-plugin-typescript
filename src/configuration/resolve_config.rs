...
pub fn resolve_config(config: ConfigKeyMap, global_config: &GlobalConfiguration) -> ResolveConfigurationResult<Configuration> {
  ...
  let padding_top = get_value(&mut config, "padding.top", 0, &mut diagnostics);
  let padding_bottom = get_value(&mut config, "padding.bottom", 0, &mut diagnostics);
  ...
  let resolved_config = Configuration {
    ...
    /* padding */
    if_statement_padding_top: get_value(&mut config, "ifStatement.padding.top", padding_top, &mut diagnostics),
    if_statement_padding_bottom: get_value(&mut config, "ifStatement.padding.bottom", padding_bottom, &mut diagnostics),
    function_declaration_padding_top: get_value(&mut config, "functionDeclaration.padding.top", padding_top, &mut diagnostics),
    function_declaration_padding_bottom: get_value(&mut config, "functionDeclaration.padding.bottom", padding_bottom, &mut diagnostics),
    function_expression_padding_top: get_value(&mut config, "functionExpression.padding.top", padding_top, &mut diagnostics),
    function_expression_padding_bottom: get_value(&mut config, "functionExpression.padding.bottom", padding_bottom, &mut diagnostics),
    arrow_function_padding_top: get_value(&mut config, "arrowFunction.padding.top", padding_top, &mut diagnostics),
    arrow_function_padding_bottom: get_value(&mut config, "arrowFunction.padding.bottom", padding_bottom, &mut diagnostics),
    class_declaration_padding_top: get_value(&mut config, "classDeclaration.padding.top", padding_top, &mut diagnostics),
    class_declaration_padding_bottom: get_value(&mut config, "classDeclaration.padding.bottom", padding_bottom, &mut diagnostics),
    class_expression_padding_top: get_value(&mut config, "classExpression.padding.top", padding_top, &mut diagnostics),
    class_expression_padding_bottom: get_value(&mut config, "classExpression.padding.bottom", padding_bottom, &mut diagnostics),
    method_padding_top: get_value(&mut config, "method.padding.top", padding_top, &mut diagnostics),
    method_padding_bottom: get_value(&mut config, "method.padding.bottom", padding_bottom, &mut diagnostics),
    constructor_padding_top: get_value(&mut config, "constructor.padding.top", padding_top, &mut diagnostics),
    constructor_padding_bottom: get_value(&mut config, "constructor.padding.bottom", padding_bottom, &mut diagnostics),
    for_statement_padding_top: get_value(&mut config, "forStatement.padding.top", padding_top, &mut diagnostics),
    for_statement_padding_bottom: get_value(&mut config, "forStatement.padding.bottom", padding_bottom, &mut diagnostics),
    for_in_statement_padding_top: get_value(&mut config, "forInStatement.padding.top", padding_top, &mut diagnostics),
    for_in_statement_padding_bottom: get_value(&mut config, "forInStatement.padding.bottom", padding_bottom, &mut diagnostics),
    for_of_statement_padding_top: get_value(&mut config, "forOfStatement.padding.top", padding_top, &mut diagnostics),
    for_of_statement_padding_bottom: get_value(&mut config, "forOfStatement.padding.bottom", padding_bottom, &mut diagnostics),
    while_statement_padding_top: get_value(&mut config, "whileStatement.padding.top", padding_top, &mut diagnostics),
    while_statement_padding_bottom: get_value(&mut config, "whileStatement.padding.bottom", padding_bottom, &mut diagnostics),
    do_while_statement_padding_top: get_value(&mut config, "doWhileStatement.padding.top", padding_top, &mut diagnostics),
    do_while_statement_padding_bottom: get_value(&mut config, "doWhileStatement.padding.bottom", padding_bottom, &mut diagnostics),
    switch_statement_padding_top: get_value(&mut config, "switchStatement.padding.top", padding_top, &mut diagnostics),
    switch_statement_padding_bottom: get_value(&mut config, "switchStatement.padding.bottom", padding_bottom, &mut diagnostics),
    switch_case_padding_top: get_value(&mut config, "switchCase.padding.top", padding_top, &mut diagnostics),
    switch_case_padding_bottom: get_value(&mut config, "switchCase.padding.bottom", padding_bottom, &mut diagnostics),
    try_statement_padding_top: get_value(&mut config, "tryStatement.padding.top", padding_top, &mut diagnostics),
    try_statement_padding_bottom: get_value(&mut config, "tryStatement.padding.bottom", padding_bottom, &mut diagnostics),
    catch_clause_padding_top: get_value(&mut config, "catchClause.padding.top", padding_top, &mut diagnostics),
    catch_clause_padding_bottom: get_value(&mut config, "catchClause.padding.bottom", padding_bottom, &mut diagnostics),
    finally_clause_padding_top: get_value(&mut config, "finallyClause.padding.top", padding_top, &mut diagnostics),
    finally_clause_padding_bottom: get_value(&mut config, "finallyClause.padding.bottom", padding_bottom, &mut diagnostics),
    block_statement_padding_top: get_value(&mut config, "blockStatement.padding.top", padding_top, &mut diagnostics),
    block_statement_padding_bottom: get_value(&mut config, "blockStatement.padding.bottom", padding_bottom, &mut diagnostics),
    enum_declaration_padding_top: get_value(&mut config, "enumDeclaration.padding.top", padding_top, &mut diagnostics),
    enum_declaration_padding_bottom: get_value(&mut config, "enumDeclaration.padding.bottom", padding_bottom, &mut diagnostics),
    interface_declaration_padding_top: get_value(&mut config, "interfaceDeclaration.padding.top", padding_top, &mut diagnostics),
    interface_declaration_padding_bottom: get_value(&mut config, "interfaceDeclaration.padding.bottom", padding_bottom, &mut diagnostics),
    module_declaration_padding_top: get_value(&mut config, "moduleDeclaration.padding.top", padding_top, &mut diagnostics),
    module_declaration_padding_bottom: get_value(&mut config, "moduleDeclaration.padding.bottom", padding_bottom, &mut diagnostics),
    object_literal_padding_top: get_value(&mut config, "objectLiteral.padding.top", padding_top, &mut diagnostics),
    object_literal_padding_bottom: get_value(&mut config, "objectLiteral.padding.bottom", padding_bottom, &mut diagnostics),
    array_literal_padding_top: get_value(&mut config, "arrayLiteral.padding.top", padding_top, &mut diagnostics),
    array_literal_padding_bottom: get_value(&mut config, "arrayLiteral.padding.bottom", padding_bottom, &mut diagnostics),
    static_block_padding_top: get_value(&mut config, "staticBlock.padding.top", padding_top, &mut diagnostics),
    static_block_padding_bottom: get_value(&mut config, "staticBlock.padding.bottom", padding_bottom, &mut diagnostics),
  };
